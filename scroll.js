...
function Init(){
	...
	$('#more').addClass('hide');
  var indicator = new WheelIndicator({element:document.getElementById('slider'),callback: function(e){ ScrollMe(e.direction); }});
	// var indicator = new WheelIndicator({element:document.querySelector('#slider'),callback: function(e){ ScrollMe(e.direction); }});
